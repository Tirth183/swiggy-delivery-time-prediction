...
# initialize dagshub
import dagshub
dagshub.init(repo_owner='Tirth183', repo_name='swiggy-delivery-time-prediction', mlflow=True)

# set the mlflow tracking server
mlflow.set_tracking_uri("https://dagshub.com/Tirth183/swiggy-delivery-time-prediction.mlflow")
